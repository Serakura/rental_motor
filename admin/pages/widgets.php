  ...
  <div class=" container-scroller">
    ...
    <nav class="navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="bg-white text-center navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="../index.php"><img src="../images/logo_star_black.png" /></a>
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="bg-white sidebar sidebar-offcanvas" id="sidebar">
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="../pages/ui-elements/buttons.php">
                <img src="../images/icons/4.png" alt="">
                <span class="menu-title">Buttons</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../pages/tables/index.php">
                <img src="../images/icons/5.png" alt="">
                <span class="menu-title">Tables</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../pages/charts/index.php">
                <img src="../images/icons/6.png" alt="">
                <span class="menu-title">Charts</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../pages/icons/index.php">
                <img src="../images/icons/7.png" alt="">
                <span class="menu-title">Icons</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../pages/ui-elements/typography.php">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="sample-pages">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="../pages/samples/blank_page.php">
                      Blank Page
                    </a>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="../pages/samples/404.php">
                      404
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="../pages/samples/500.php">
                      500
                    </a>
                  </li>
                </ul>
